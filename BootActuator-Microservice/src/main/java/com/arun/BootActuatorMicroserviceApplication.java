...
public class BootActuatorMicroserviceApplication {

	public static void main(String[] args) {
		SpringApplication.run(BootActuatorMicroserviceApplication.class, args);
	}
	...
	class HelloWorldController {
		...
		@Autowired
		HelloWorldController(TPSHealth health,CounterService counterService, GaugeService gaugeService){
			this.health = health;
